...
import org.jinstagram.auth.oauth.InstagramAuthServiceImpl;
...
public class InstagramApi {
	...
	public InstagramAuthServiceImpl createService(OAuthConfig config) {
		return new InstagramAuthServiceImpl(this, config);
	}
}
