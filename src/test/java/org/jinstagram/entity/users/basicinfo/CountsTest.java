...
/**
 * The class <code>CountsTest</code> contains tests for the class <code>{@link Counts}</code>.
 */
public class CountsTest {
     ...
     */
    @Test
    public void testGetFollowedBy_1()
            throws Exception {
